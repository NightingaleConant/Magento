...
class Mage_Adminhtml_Block_Sales_Order_Invoice_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        if ($this->_isAllowedAction('cancel') && $this->getInvoice()->canCancel() && !$this->getInvoice()->getOrder()->getInstallmentTypeId()) {
        ...
        if ($this->_isAllowedAction('capture') && $this->getInvoice()->canCapture() && !$this->getInvoice()->getOrder()->getInstallmentTypeId()) {
