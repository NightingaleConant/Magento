            ...
            if ($methodInstance->isInitializeNeeded()) {
                ...
                switch ($action) {
                    ...
                    case Mage_Payment_Model_Method_Abstract::ACTION_AUTHORIZE:
                        $online = ($order->getInstallmentTypeId()) ? false : true;
                        $this->_authorize($online, $order->getBaseTotalDue()); // base amount will be set inside
    ...
    protected function _authorize($isOnline, $amount)
    {
        ...
        if ($this->getIsTransactionPending()) {
            ...
            if ($isOnline) {
                ...
                $message = Mage::helper('sales')->__('Order created without authorization due to installment plan');
            }
        }
