...
class Mage_Payment_Block_Info_Cc extends Mage_Payment_Block_Info
{
    ...
    public function getInstallmentTypeId()
    {
        return $this->getInfo()->getOrder()->getInstallmentTypeId();
    }
    ...
    protected function _prepareSpecificInformation($transport = null)
    {
        ...
        {
            $type = Mage::getModel('installment/type')->load($this->getInstallmentTypeId());
            $data[Mage::helper('installment')->__('Installment Plan')] = $type->getInstallmentTypeId() .' ('. $type->getInstallmentTypeDescription() .')' ;
        }
