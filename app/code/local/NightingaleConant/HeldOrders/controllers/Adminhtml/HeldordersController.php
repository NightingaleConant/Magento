...
class NightingaleConant_HeldOrders_Adminhtml_HeldordersController extends Mage_Adminhtml_Controller_Action {
    ...
    public function exportCsvAction() {
        $fileName = 'heldorders.csv';
        $content = $this->getLayout()->createBlock('heldorders/adminhtml_heldorders_grid')
                        ->getCsv();
        $this->_sendUploadResponse($fileName, $content);
    }
 
    public function exportXmlAction() {
        $fileName = 'heldorders.xml';
        $content = $this->getLayout()->createBlock('heldorders/adminhtml_heldorders_grid')
                        ->getXml();
        $this->_sendUploadResponse($fileName, $content);
    }
