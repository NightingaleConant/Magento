...
class NightingaleConant_OrderPlacedBy_Adminhtml_OrderplacedbyController extends Mage_Adminhtml_Controller_Action {
    ...
    public function exportCsvAction() {
        $fileName = 'orderplacedby.csv';
        $content = $this->getLayout()->createBlock('orderplacedby/adminhtml_orderplacedby_grid')
                        ->getCsv();
        $this->_sendUploadResponse($fileName, $content);
    }
 
    public function exportXmlAction() {
        $fileName = 'orderplacedby.xml';
        $content = $this->getLayout()->createBlock('orderplacedby/adminhtml_orderplacedby_grid')
                        ->getXml();
        $this->_sendUploadResponse($fileName, $content);
    }
